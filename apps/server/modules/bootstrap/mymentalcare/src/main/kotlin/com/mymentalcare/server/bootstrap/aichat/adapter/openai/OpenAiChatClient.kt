...
import com.mymentalcare.server.application.aichat.policy.MindChatResponsePolicy
import com.mymentalcare.server.application.aichat.policy.RECENT_ASSISTANT_REPLY_LIMIT
...
class OpenAiChatClient(
    ...
    private fun buildSummaryMemoryContent(summaryContext: com.mymentalcare.server.application.aichat.response.AiChatSummaryContext): String {
        return listOfNotNull(
